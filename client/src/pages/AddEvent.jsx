  ...
  if (formData.isSubmitted) {
    return (
      <div className="flex flex-col ml-20 mt-10">
        <h1 className="font-bold text-[36px] mb-5">Event Posted Successfully!</h1>
        <Link to="/" className="text-black-500 underline hover:text-blue-700 transition-colors duration-300">
  Go to Home Page
</Link>
      </div>
    );
